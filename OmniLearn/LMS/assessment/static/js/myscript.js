...
function formValidation(){
  ...
  if($("input[name=SAA1]:checked").length <= 0 ||
    ...
    $("input[name=SAhap]:checked").length <= 0){
      ...
      if($("input[name=SAA1]:checked").length <= 0){
        $("#SATD1 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD1 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAA2]:checked").length <= 0){
        $("#SATD5 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD5 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAA3]:checked").length <= 0){
        $("#SATD15 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD15 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAP1]:checked").length <= 0){
        $("#SATD3 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD3 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAP2]:checked").length <= 0){
        $("#SATD13 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD13 input[type=radio]").closest("td").removeClass("border");
      }

      if($("input[name=SAP3]:checked").length <= 0){
        $("#SATD22 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD22 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAE1]:checked").length <= 0){
        $("#SATD2 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD2 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAE2]:checked").length <= 0){
        $("#SATD10 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD10 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAE3]:checked").length <= 0){
        $("#SATD17 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD17 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAN1]:checked").length <= 0){
        $("#SATD4 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD4 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAN2]:checked").length <= 0){
        $("#SATD14 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD14 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAN3]:checked").length <= 0){
        $("#SATD16 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD16 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SALon]:checked").length <= 0){
        $("#SATD11 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD11 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAH1]:checked").length <= 0){
        $("#SATD6 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD6 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAH2]:checked").length <= 0){
        $("#SATD12 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD12 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAH3]:checked").length <= 0){
        $("#SATD18 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD18 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAM1]:checked").length <= 0){
        $("#SATD7 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD7 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAM2]:checked").length <= 0){
        $("#SATD9 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD9 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAM3]:checked").length <= 0){
        $("#SATD20 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD20 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAR1]:checked").length <= 0){
        $("#SATD8 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD8 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAR2]:checked").length <= 0){
        $("#SATD19 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD19 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAR3]:checked").length <= 0){
        $("#SATD21 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD21 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SAhap]:checked").length <= 0){
        $("#SATD23 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SATD23 input[type=radio]").closest("td").removeClass("border");
      }
  }else{
    $("#SATD1 input[type=radio]").closest("td").removeClass("border");
    $("#SATD2 input[type=radio]").closest("td").removeClass("border");
  ...
  if($("input[name=SBQ1]:checked").length <= 0 ||
    ...
    $("input[name=SBQ12]:checked").length <= 0){
      ...
      setTimeout(function(){$('.toast').toast('hide');},5000);
      if($("input[name=SBQ1]:checked").length <= 0){
        $("#SBTD1 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD1 input[type=radio]").closest("td").removeClass("border");
      }

      if($("input[name=SBQ2]:checked").length <= 0){
        $("#SBTD2 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD2 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ3]:checked").length <= 0){
        $("#SBTD3 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD3 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ4]:checked").length <= 0){
        $("#SBTD4 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD4 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ5]:checked").length <= 0){
        $("#SBTD5 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD5 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ6]:checked").length <= 0){
        $("#SBTD6 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD6 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ7]:checked").length <= 0){
        $("#SBTD7 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD7 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ8]:checked").length <= 0){
        $("#SBTD8 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD8 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ9]:checked").length <= 0){
        $("#SBTD9 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD9 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ10]:checked").length <= 0){
        $("#SBTD10 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD10 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ11]:checked").length <= 0){
        $("#SBTD11 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD11 input[type=radio]").closest("td").removeClass("border");
      }
      if($("input[name=SBQ12]:checked").length <= 0){
        $("#SBTD12 input[type=radio]").closest("td").addClass("border");
      }else{
        $("#SBTD12 input[type=radio]").closest("td").removeClass("border");
      }
  }else{
    $("#SBTD1 input[type=radio]").closest("td").removeClass("border");
    $("#SBTD2 input[type=radio]").closest("td").removeClass("border");
